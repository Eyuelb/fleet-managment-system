...
//   //   sql`'current_setting('app.user_id'::text,'t')'`
//   // ),
//   // updatedBy: uuid("updated_by").default(
//   //   sql`'current_setting('app.user_id'::text,'t')'`
//   // ),
// };
...
//   "Rejected",
// ]);
// export const requestEnum = pgEnum("requestEnum", [
//   "Fuel",
//   "Maintenance",
//   "Fleet",
// ]);
...
//   vehicleIdentificationNumber:text("vehicleIdentificationNumber"),
//   seatCapacity: text("seatCapacity"),
//   status: text("status"),
//   driverName: text("status"),
// });
